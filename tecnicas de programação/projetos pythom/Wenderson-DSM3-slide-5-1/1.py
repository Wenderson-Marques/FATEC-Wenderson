...
class Cadastro:
    ...
    #email
        self.label_email = Label(self.frame_form, text="email:",bg="#870d35",fg="#ffffff")
        self.entry_email = Entry(self.frame_form,width=40)
        self.label_email.grid(row=2, column=1, pady=5,padx=(100,0),sticky="e")
        self.entry_email.grid(row=2, column=2, pady=5)
    #telefone
        ...
        self.buton_cadastrar=Button(self.frame_form,text="Cadastrar",command=self.cadastrar_cliente,height=2,width=10,relief="solid",bg="green")
